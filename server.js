...
app.post('/schedule-automation', authenticateToken, async (req, res) => {
  try {
    ...
    await setDoc(userRef, { 
      ...
      automationScheduled: true  // Add this flag to indicate that automation is scheduled
    }, { merge: true });
...
async function getUsersForAutomation() {
  ...
  console.log('Processed users for automation:', users); // Debug log
  return users;
}
...
// Add this line to log the server time
console.log('Server time:', new Date().toLocaleString('en-ZA', { timeZone: 'Africa/Johannesburg' }));

//(minute hour day-of-month month day-of-week) (0 1,9,17 * * 1-6) run at 01h00, 09h00, 17h00 Mon-Sat
